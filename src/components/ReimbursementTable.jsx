        ...
        <tbody>
            {reimbursements.map((reimbursement)=>(
                ...
                <tr key={reimbursement.reimbursementId} class="bg-white border-b dark:border-gray-700 ">
                    ...
                    <td class="px-6 py-4">
                        <a onClick={()=>openReimbursementDetails(reimbursement.reimbursementId, reimbursement.amount, reimbursement.type, reimbursement.employeeId, reimbursement.description, reimbursement.image, reimbursement.name, reimbursement.reimbursementAmount)}  class="font-medium text-blue-600 dark:text-blue-500 hover:underline cursor-pointer">Details</a>
                    </td>
