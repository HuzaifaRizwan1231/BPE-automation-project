      ...
      <div className={`fixed-form ${props.showForm ? "block" : "hidden"}`}>
        ...
        <div className="form-wrapper">
          <form class="max-w-md mx-auto">
            ...
            <div class="relative z-0 w-full mb-5 group">
            <textarea type="text" id="large-input" placeholder="Description" class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
            </div>
